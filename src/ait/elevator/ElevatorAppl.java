...
public class ElevatorAppl {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Elevator apache = new Elevator("Apache");
        Truck[] trucks = new Truck[N_TRUCK];

        for (int i = 0; i < trucks.length; i++) {
            trucks[i] = new Truck(N_RACES, CAPACITY, lenin, apache);
        }
        ...
        System.out.println("Elevator " + apache.getName() + " has " + apache.getCurrentVolume());
    }
}
